var Dajaxice = {
        ...
        cars: {
            ...
            getmodel: function(callback_function, argv, custom_settings){
                Dajaxice.call('cars.getmodel', callback_function, argv, custom_settings);
            }
    ...
    call: function(dajaxice_function, dajaxice_callback, argv, custom_settings)
    {
        ...
        oXMLHttpRequest.open('POST', '/greengears/cars/dajax/'+dajaxice_function+'/');
